...
## Specializations
*Add as many as needed. Each specialization typically grants situational bonuses.*

| Specialization | Related Skill | Effect / Notes |
|----------------|---------------|----------------|
|                |               |                |
|                |               |                |
|                |               |                |
...
## Merits
*Structural or cultural advantages. Values may be positive or negative.*
...
## Flaws
*Weaknesses, liabilities, or ethical compromises.*
...
## Fleet Composition
*Optional – link agency choices directly to campaign consequences.*

| Ship Class | Role | Quantity | Status / Notes |
|------------|------|----------|----------------|
|            |      |          |                |
|            |      |          |                |
